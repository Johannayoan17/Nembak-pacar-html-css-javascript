ftom=0;jikapr=1;ftganti=0;flag=1;flagg=1;fungsi=0;Bn2.innerHTML=Bn.innerHTML;
function showDiv() {
...
setTimeout(ftmuncul,200);
    ...
    fungsi=1;setTimeout(tombol,500);}
function ftmuncul() {
    if(ftganti==0){
...
const swalst = Swal.mixin({
        timer: 2777, allowOutsideClick: false, 
...
const style = document.createElement('style'); 
    ...
    var yyyy = today.getFullYear();const monthNames = ["Januari", "Februari", "Maret", "April",
    "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember"];
    today = dd + ' ' + monthNames[today.getMonth()] + ' ' + yyyy;
   const body = document.querySelector("body");
function createHeart() {const heart = document.createElement("div"); 
    heart.className = "fas fa-heart"; heart.style.left = (Math.random() * 90)+"vw"; 
